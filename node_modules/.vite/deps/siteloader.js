...
// node_modules/siteloader/dist/sl.js
var l = class {
  /**
  ...
  constructor(e) {
    this._allResorceData = e, this._allResourceCount = 0, this._allDoms = {
      ...
      // error: null,
      progress: null
    }, this.progressSpeed = 20, this.needSpeedUp = false, this._isStageLoad && this._allResorceData.forEach((t) => {
  ...
  _loadAllImg() {
    this._allDoms.imgsDoms.forEach((e) => {
      e.onload = () => {
        this._allResourcesTag[e.currentSrc || e.src] || (this._loadedCount++, this._trueLoadControl(), this._allResourcesTag[e.currentSrc || e.src] = true);
      }, e.onerror = () => {
        this._allResourcesTag[e.currentSrc || e.src] || (this._errorLoad("图片", e.currentSrc || e.src), this._allResourcesTag[e.currentSrc || e.src] = true);
  ...
  _loadAllMedia() {
    this._allDoms.mediaDoms.forEach((e) => {
      e.addEventListener("canplaythrough", () => {
        this._allResourcesTag[e.src] || (this._loadedCount++, this._trueLoadControl(), this._allResourcesTag[e.src] = true);
      }), e.addEventListener("error", () => {
        this._allResourcesTag[e.src] || (this._errorLoad("音频/视频", e.currentSrc || e.src), this._allResourcesTag[e.src] = true);
      }), e.src = e.currentSrc || e.src;
    });
  }
  // 分阶段加载调用的方法
  ...
  _loadStageImg(e, t) {
    e.forEach((s) => {
      s.onload = () => {
        this._allResourcesTag[s.currentSrc || s.src] || (this._stageResourceLoadedCount[t]++, this._loadedCount++, this._stageLoadCheck(t), this._trueLoadControl(), this._allResourcesTag[s.currentSrc || s.src] = true);
      }, s.onerror = () => {
        this._allResourcesTag[s.currentSrc || s.src] || (this._errorLoad("图片", s.currentSrc || s.src), this._allResourcesTag[s.currentSrc || s.src] = true);
  ...
  _loadStageMedia(e, t) {
    e.forEach((s) => {
      s.addEventListener("canplaythrough", () => {
        this._allResourcesTag[s.src] || (this._stageResourceLoadedCount[t]++, this._loadedCount++, this._stageLoadCheck(t), this._trueLoadControl(), this._allResourcesTag[s.src] = true);
      }), s.addEventListener("error", () => {
        this._allResourcesTag[s.src] || (this._errorLoad("音频/视频", s.currentSrc || s.src), this._allResourcesTag[s.src] = true);
      }), s.src = s.currentSrc || s.src;
    });
  }
  ...
  _progressDetect() {
    const e = () => {
      ...
      }), this._progress === this._targetProgress && clearInterval(this._progressChangeTimer), this._progress === 100 && this._loadFinish(), this._progress < 60 && this._targetProgress === 100 && this.needSpeedUp && (clearInterval(this._progressChangeTimer), this._progressChangeTimer = setInterval(e, 0), this.needSpeedUp = false));
    };
